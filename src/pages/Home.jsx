                    ...
                    <div className="sm:col-span-6 lg:col-span-5">
                        ...
                        <div
                            ...
                            <div className="lg:pl-16">
                                ...
                                <p className="text-gray-700 text-xs mt-2">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit.
                    ...
                    <div className="sm:col-span-6 lg:col-span-4">
                        <div className="flex items-start mb-3 pb-3">
                            ...
                            <div className="text-sm">
                                ...
                                <a href="#" className="text-gray-900 font-medium hover:text-indigo-600 leading-none">Cristiano
                                    Ronaldo
                        ...
                        <div className="flex items-start mb-3 pb-3">
                            ...
                            <div className="text-sm w-2/3">
                                ...
                                <a href="#" className="text-gray-900 font-medium hover:text-indigo-600 leading-none">Barcelona
                                    v Bayern
                                    Munich </a>
                            </div>
                        </div>
